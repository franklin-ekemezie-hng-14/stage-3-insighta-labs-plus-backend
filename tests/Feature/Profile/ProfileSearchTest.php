...
beforeEach(function () {
    Profile::create(['name' => 'obi', 'gender' => 'male', 'gender_probability' => 0.95, 'age' => 20, 'age_group' => 'adult', 'country_id' => 'NG', 'country_name' => 'Nigeria', 'country_probability' => 0.9]); // young male from nigeria
    Profile::create(['name' => 'ada', 'gender' => 'female', 'gender_probability' => 0.99, 'age' => 35, 'age_group' => 'adult', 'country_id' => 'NG', 'country_name' => 'Nigeria', 'country_probability' => 0.8]); // female above 30 from nigeria
    Profile::create(['name' => 'mwangi', 'gender' => 'male', 'gender_probability' => 0.9, 'age' => 25, 'age_group' => 'adult', 'country_id' => 'KE', 'country_name' => 'Kenya', 'country_probability' => 0.95]); // adult male from kenya
    Profile::create(['name' => 'joao', 'gender' => 'male', 'gender_probability' => 0.96, 'age' => 18, 'age_group' => 'teenager', 'country_id' => 'AO', 'country_name' => 'Angola', 'country_probability' => 0.85]); // male teenager above 17 from angola
});
