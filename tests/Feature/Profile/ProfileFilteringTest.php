...
beforeEach(function () {
    Profile::query()->create(['name' => 'john', 'gender' => 'male', 'gender_probability' => 0.95, 'age' => 45, 'age_group' => 'adult', 'country_id' => 'US', 'country_name' => 'United States', 'country_probability' => 0.9]);
    Profile::query()->create(['name' => 'jane', 'gender' => 'female', 'gender_probability' => 0.99, 'age' => 30, 'age_group' => 'adult', 'country_id' => 'CA', 'country_name' => 'Canada', 'country_probability' => 0.8]);
    Profile::query()->create(['name' => 'kofi', 'gender' => 'male', 'gender_probability' => 0.80, 'age' => 14, 'age_group' => 'teenager', 'country_id' => 'GH', 'country_name' => 'Ghana', 'country_probability' => 0.95]);
    Profile::query()->create(['name' => 'mary', 'gender' => 'female', 'gender_probability' => 0.96, 'age' => 65, 'age_group' => 'senior', 'country_id' => 'UK', 'country_name' => 'United Kingdom', 'country_probability' => 0.85]);
...
it('filters by gender case insensitive', function () {
    ...
    expect($names)->toContain('john', 'kofi')
        ->and($names)->not->toContain('jane', 'mary');
});
